...
<body>
			...
			<div class="row">
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--login form-->
						...
						<form class="signInForm" method="POST" action="action/login.php">
							<input type="text" name="email" placeholder="Email Address" data-validate="required,email"/>
							<input type="password" name="password" placeholder="Password" data-validate="required,min(6)"/>
				...
				<div class="col-sm-4">
					<div class="signup-form"><!--sign up form-->
						...
						<form class="signUpForm" method="POST" action="action/signup.php">
							<input type="text" name="name" placeholder="Name" data-validate="required"/>
							<input type="text" name="email" placeholder="Email Address" data-validate="required,email"/>
							<input type="password" name="password" placeholder="Password" data-validate="required,min(6)"/>
	...
	<script type="text/javascript">
		...
		<?php 
			if(isset($_SESSION["registerSuccess"]) && !empty($_SESSION["registerSuccess"])) {
