...
<body>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					...
					<ul class="pagination">
							<button onclick="loadMore(this.id);" id="<?php echo $currentID; ?>" class="btn btn-primary showMoreButton">Show more</button>
					</ul>
	...
	<?php
		if(isset($_SESSION["purchased"]) && !empty($_SESSION["purchased"])) {
			?>
			$.notify({
				// options
